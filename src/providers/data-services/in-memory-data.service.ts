...
export class InMemDataService implements InMemoryDbService {
  createDb() {
    ...
    const users = [
      { id: 1, civility: 3, name: 'Larré', forname: 'Guillaume', email: 'gl@gl.com', pwd: 'gl', specialty_id: 19, online: true, user_type: 2, tel: "+590690362206", skype:"karen.helouet" },
      { id: 2, civility: 3, name: 'Barreau', forname: 'Germain',  email: 'gb@gb.com', pwd: 'gb', specialty_id: 26, online: true, user_type: 2, tel: "+33610925543", skype:"germainbarreau"   },
